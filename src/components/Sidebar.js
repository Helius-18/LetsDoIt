...
const Sidebar = () => {
  return (
    <div className="text-bg-dark position-sticky top-0 d-none d-md-block" style={{ height: '100vh', width: '250px' }}>
        ...
        <div className="pt-3 h-100">
          <div className="d-flex flex-column h-100 gap-3">
            ...
            <div className="flex-shrink-0 d-flex flex-column gap-3">
              <li className="list-group-item text-bg-dark list-group-item-action">
